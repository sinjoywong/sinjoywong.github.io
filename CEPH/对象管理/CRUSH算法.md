...
- #### 2. crush map 基本数据结构 和crush 算法的介绍
  ...
  **(图片太小右键新标签页打开查看)**
  ...
  ![image](.Ceph%20CRUSH%E7%AE%97%E6%B3%95.assets/crush%20map%20struct.jpg)
  ...
  *这里借用《CEPH 之rados 设计原理和实现》一书中的示意图解析firstn选择的过程*![image](.Ceph%20CRUSH%E7%AE%97%E6%B3%95.assets/firstn.png)
...
- #### 1. 函数详解
  ...
  *crush_do_rule* 是crush map的中rule的基本处理函数，会根据rule 的step 一步步执行，
  ...
  ![image](.Ceph%20CRUSH%E7%AE%97%E6%B3%95.assets/diff-rule.png)
